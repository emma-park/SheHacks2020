...
class SecondScreenViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        var request = URLRequest(url: URL(string: "https://api.taggun.io/api/receipt/v1/verbose/file")!,timeoutInterval: Double.infinity)
        request.addValue("multipart/form-data", forHTTPHeaderField: "Content-Type")
        request.addValue("7339315034e311ea8bfadfb7eb1aa8b5", forHTTPHeaderField: "apikey")
